...
| M1 | First vertical slice: seeded login → create a client → list clients (proves G1/G3/G10 end-to-end) | 🔨 In progress (2026-07-02; segment checklist in [status.md](./status.md)) |
